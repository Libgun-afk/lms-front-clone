    ...
    return(
        <div className={`account-sidebar ${sidebarShrink ? 'shrink' : ''}`}>
            ...
            <ul className="account-sidebar_menu">
                <li>
                    <Link href="/v1/dashboard" className={`menu-item ${isActive("/v1/dashboard") ? "active" : ""}`}>
                        <div className="icon"><DashboardIcon/></div>
                        <p>Хянах самбар</p>
                    </Link>
                </li>
                <li>
                    <Link href="/v1/product" className={`menu-item ${isActive("/v1/product") ? "active" : ""}`}>
                        <div className="icon"><ProductIcon/></div>
                        <p>Бараа материал</p>
                    </Link>
                </li>
                <li>
                    <Link href="/v1/users" className={`menu-item ${isActive("/v1/users") ? "active" : ""}`}>
                        <div className="icon"><PeopleIcon/></div>
                        <p>Хэрэглэгч</p>
                    </Link>
                </li>
                <li>
                    <Link href="/v1/branch" className={`menu-item ${isActive("/v1/branch") ? "active" : ""}`}>
                        <div className="icon"><BranchIcon/></div>
                        <p>Салбар</p>
                    </Link>
                </li>
                <li>
                    <Link href="/v1/discount" className={`menu-item ${isActive("/v1/discount") ? "active" : ""}`}>
                        <div className="icon"><DiscountIcon/></div>
                        <p>Хямдрал, урамшуулал</p>
                    </Link>
                </li>
            </ul>
            <div className="account-sidebar_bottom">
                <div className="menu-shrink" onClick={handleMenuExpand}>
                    <div className="icon"><ArrowLefticon/></div>
                    <p>Багасгах</p>
                </div>
